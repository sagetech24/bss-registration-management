...
function rm_public_ui_strings(string $locale): array
{
    $keys = [
        ...
        'wizard.members.exact_package_note',
        ...
        'guest_manage.heading',
        'guest_manage.title',
        'guest_manage.lookup_title',
        'guest_manage.lookup_desc',
        'guest_manage.primary_registrant',
        'guest_manage.existing_guests',
        'guest_manage.slots_remaining',
        'guest_manage.add_guests_intro',
        'guest_manage.submit_pay',
        'guest_manage.submit_free',
        'guest_manage.btn.remove_last',
        'guest_manage.error.no_event',
        'guest_manage.error.event_not_found',
        'guest_manage.error.v1_not_supported',
        'guest_manage.error.post_reg_disabled',
        'guest_manage.error.session_expired',
        'guest_manage.error.login_not_found',
        'guest_manage.error.wrong_event',
        'guest_manage.error.not_paid',
        'guest_manage.error.capacity_full',
        'guest_manage.error.event_full',
        'guest_manage.error.no_guests',
        'guest_manage.error.too_many',
        'guest_manage.error.save_failed',
        'guest_manage.error.payment_failed',
        'guest_manage.error.rate_limited',
        'guest_manage.success.loaded',
        'guest_manage.success.added',
        'guest_manage.success.emailed',
        'guest_manage.closed_notice',
        'email.subject',
        'email.title',
        'email.banner',
        'email.hello',
        ...
        'email.add_remaining',
        'email.add_guests_later',
        'email.add_guests_later_desc',
        'email.add_guests_cta',
        'email.addon_subject',
        'email.addon_title',
        'email.addon_banner',
        'email.addon_thank_you',
