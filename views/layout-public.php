<!doctype html>
<html lang="<?php echo esc_attr((string) ($html_lang ?? 'en')); ?>">
    <head>
        <meta charset="utf-8" />
                ...
                >
                    ...
                    <div class="relative mx-auto w-full <?php echo esc_attr($page_width); ?> px-4 py-8 <?php echo $has_banner ? 'text-white' : 'text-slate-900'; ?>">
                        ...
                        <?php if ($page_description !== '') : ?>
                            <div class="mt-3 text-base leading-relaxed <?php echo $has_banner ? 'text-white/90' : 'text-slate-600'; ?>">
                            ...
                            <ul class="mt-5 space-y-1 text-base <?php echo $has_banner ? 'text-white/90' : 'text-slate-700'; ?>">
                                <?php if (($event_present['date_display'] ?? '') !== '') : ?>
                                    <li class="flex items-start gap-2.5">
                                        ...
                                        <span class="text-sm"><?php echo wp_kses_post((string) $event_present['date_display']); ?></span>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (($event_present['venue'] ?? '') !== '') : ?>
                                    <li class="flex items-start gap-2.5">
                                        ...
                                        <span class="text-sm"><?php echo wp_kses_post((string) $event_present['venue']); ?></span>
                                    </li>
                                <?php endif; ?>
                                <?php
