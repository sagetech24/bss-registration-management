...
$greet_name = esc_html((string) ($primary['full_name'] ?? $et('wizard.role.registrant')));
 ...
 */
$rm_email_detail_rows = static function (array $person) use ($et): array {
    $rows = [];
    $map = [
        'full_name'   => $et('email.label.name'),
        'email'       => $et('email.label.email'),
        'contact'     => $et('email.label.contact'),
        'church_name' => $et('email.label.church'),
        'order_number'=> $et('email.label.registration_number'),
    ];
...
<head>
    ...
    <title><?php echo esc_html($et('email.title')); ?></title>
</head>
            ...
            <td align="center">
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:4px;overflow:hidden;">
                    ...
                    <tr>
                        <td align="center" style="background-color:#27a532;padding:28px 24px;">
                            <p style="margin:0;font-size:24px;line-height:1.3;font-weight:bold;color:#ffffff;">
                                <?php echo esc_html($et('email.banner')); ?>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px 28px 8px 28px;">
                            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.6;color:#3c434a;">
                                <?php echo esc_html($et('email.hello', ['name' => wp_strip_all_tags($greet_name)])); ?>
                            </p>
                            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.6;color:#3c434a;">
                                <?php echo esc_html($et('email.thank_you')); ?>
                                <strong style="color:#1d2327;"><?php echo $event_title; ?></strong>
                            </p>
                            <p style="margin:0 0 24px 0;font-size:15px;line-height:1.6;color:#3c434a;">
                                <?php echo esc_html($et('email.review')); ?>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 28px 8px 28px;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #dcdcde;border-radius:3px;">
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;width:38%;border-bottom:1px solid #f0f0f1;"><?php echo esc_html($et('email.section.event')); ?></td>
                                ...
                                <?php if ($event_date !== '') : ?>
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;border-bottom:1px solid #f0f0f1;"><?php echo esc_html($et('email.label.date_time')); ?></td>
                                    <td style="padding:12px 14px;font-size:14px;color:#1d2327;border-bottom:1px solid #f0f0f1;"><?php echo esc_html($event_date); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if ($event_venue !== '') : ?>
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;"><?php echo esc_html($et('email.label.venue')); ?></td>
                    ...
                    <tr>
                        <td style="padding:20px 28px 8px 28px;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #dcdcde;border-radius:3px;">
                                ...
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;border-bottom:1px solid #f0f0f1;"><?php echo esc_html($et('email.label.confirmation')); ?></td>
                                ...
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;border-bottom:1px solid #f0f0f1;"><?php echo esc_html($et('email.label.package')); ?></td>
                                ...
                                <?php endif; ?>
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;border-bottom:1px solid #f0f0f1;"><?php echo esc_html($et('email.label.amount_paid')); ?></td>
                                ...
                                <tr>
                                    <td style="padding:12px 14px;font-size:14px;color:#646970;"><?php echo esc_html($et('email.label.payment_method')); ?></td>
                    ...
                    <tr>
                        <td style="padding:20px 28px 8px 28px;">
                            <p style="margin:0 0 10px 0;font-size:13px;font-weight:bold;letter-spacing:0.04em;text-transform:uppercase;color:#1a5f4a;">
                                <?php echo esc_html($et('email.section.registrant')); ?>
                            </p>
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #dcdcde;border-radius:3px;">
                                <?php
                    ...
                    <tr>
                        <td style="padding:20px 28px 8px 28px;">
                            <p style="margin:0 0 10px 0;font-size:13px;font-weight:bold;letter-spacing:0.04em;text-transform:uppercase;color:#1a5f4a;">
                                <?php echo esc_html($et('email.section.members')); ?>
                            </p>
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #dcdcde;border-radius:3px;">
                                <tr>
                                    ...
                                    <td style="padding:10px 14px;font-size:12px;font-weight:bold;color:#646970;background-color:#f6f7f7;border-bottom:1px solid #dcdcde;"><?php echo esc_html($et('email.label.role')); ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:10px 14px;font-size:13px;color:#1d2327;border-bottom:1px solid #f0f0f1;<?php echo $row_bg; ?>"><?php echo esc_html((string) ($member['role_label'] ?? $et('email.role.member'))); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:20px 28px 8px 28px;">
                            <p style="margin:0 0 10px 0;font-size:13px;font-weight:bold;letter-spacing:0.04em;text-transform:uppercase;color:#1a5f4a;">
                                <?php echo esc_html($et('email.complete_roster')); ?>
                            </p>
                                    ...
                                    <td style="padding:16px 18px;">
                                        ...
                                        <p style="margin:0 0 16px 0;">
                                            <a href="<?php echo esc_url($manage_group_url); ?>" style="display:inline-block;background-color:#1d4ed8;color:#ffffff;text-decoration:none;font-size:14px;font-weight:bold;padding:12px 18px;border-radius:4px;">
                                                <?php echo esc_html($et('email.add_remaining')); ?>
                                            </a>
                                        </p>
                    ...
                    <tr>
                        <td style="padding:28px 28px 32px 28px;">
                            <p style="margin:0;font-size:13px;line-height:1.6;color:#646970;">
                                <?php echo esc_html($et('email.footer.org')); ?><br />
                                <?php echo esc_html($et('email.footer.reply')); ?>
                            </p>
                        </td>
                    </tr>
                </table>
